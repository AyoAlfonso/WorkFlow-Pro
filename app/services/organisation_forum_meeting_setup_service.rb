class OrganisationForumMeetingSetupService
  ...
  def call
    ...
    meetings_this_year = MeetingSearch.new(Meeting, { team_id: team.id, fiscal_year: fiscal_year, meeting_type: :organisation_forum_monthly }).search
  ...
  def fetch_meetings_for_year
    MeetingSearch.new(Meeting, { team_id: team.id, fiscal_year: fiscal_year, meeting_type: :organisation_forum_monthly }).search
  end
end
