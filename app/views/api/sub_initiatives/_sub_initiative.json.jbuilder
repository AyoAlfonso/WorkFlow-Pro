json.extract! sub_initiative, :id, :quarterly_goal_id, :created_by_id, :owned_by_id, :importance, :context_description, :quarter, :created_at, :closed_at
...
json.key_elements sub_initiative.key_elements do |key_element|
