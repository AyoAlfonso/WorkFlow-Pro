json.extract! annual_initiative, :id, :created_by_id, :owned_by_id, :importance, :key_elements, :company_id, :context_description, :fiscal_year, :closed_at
...
json.quarterly_goals annual_initiative.fiscal_year >= current_company.current_fiscal_year ? annual_initiative.quarterly_goals.optimized.present_or_future(current_company) : annual_initiative.quarterly_goals.optimized do |quarterly_goal|
