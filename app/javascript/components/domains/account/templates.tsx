  ...
  (): JSX.Element => {
    ...
    const save = () => {
      ...
      descriptionTemplateStore.updateDescriptiveTemplates({
        descriptionTemplate: [flattenedobjectivesTemplate, flattenedInitiativesTemplate, flattenedKPITemplate],
      });
      const form = new FormData();
      createFormData(form, "description_templates_attributes", [initiativesTemplateBody, objectivesTemplateBody, kpiTemplateBody] )
              ...
              <BodyContainer>
                <PersonalInfoContainer>
                  ...
                  <TrixEditor
                    ...
                    mergeTags={[]}
                    onChange={(html, text) => {
                       setObjectivesTemplateBody({id: objectivesTemplate.id, title: objectivesTemplate.title, body: html});
                    }}
                  ...
                  <TrixEditor
                    ...
                    mergeTags={[]}
                    onChange={(html, text) => {
                      setInitiativesTemplateBody({id: initiativesTemplate.id, title: initiativesTemplate.title, body: html});
                    }}
                    onEditorReady={editor => {
                      editor.element.addEventListener("trix-file-accept", event => {
                        event.preventDefault();
                  ...
                  <TrixEditor
                    ...
                    mergeTags={[]}
                    onChange={(html, text) => {
                      setKPITemplateBody({id: kpiTemplate.id, title: kpiTemplate.title, body: html});
                    }}
                    onEditorReady={editor => {
                      editor.element.addEventListener("trix-file-accept", event => {
                        event.preventDefault();
