...
import { DummyAnnualInitiativeCardExpanded } from "./dummy-annual-initiative-card-expanded";
    ...
    return (
      <ColumnContainer onboarding={onboarding} marginRight={marginRight} marginLeft={marginLeft}>
        <Container
          ...
          onMouseEnter={e => { setShowOptions(grey60); }}
          onMouseLeave={e => { setShowOptions(white); }}
        >
          <HeaderContainer>
        ...
        {!showMinimizedCard ? (
          <DummyAnnualInitiativeCardExpanded
            annualInitiative={annualInitiative}
