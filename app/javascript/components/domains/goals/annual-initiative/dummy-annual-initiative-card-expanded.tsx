...
import { DummyQuarterlyGoalCard } from "../quarterly-goal/dummy-quarterly-goal-card";
import { DummySubInitiativeCardsExpanded } from "../sub-initiative/dummy-sub-initiative-card-expanded";
import { observer } from "mobx-react";
import { baseTheme } from "../../../../themes";
import { IAnnualInitiativeCardExpandedProps } from "~/types/annual-initiative-cards";
import { sortByDate } from "~/utils/sorting";

export const DummyAnnualInitiativeCardExpanded = observer(
