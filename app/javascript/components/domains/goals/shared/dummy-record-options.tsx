...
import { DummyGoalDropdownOptions } from "./dummy-goal-dropdown-options";
...
export const DummyRecordOptions = (props: IRecordOptionsProps): JSX.Element => {
