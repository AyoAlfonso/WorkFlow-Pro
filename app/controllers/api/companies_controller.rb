class Api::CompaniesController < Api::ApplicationController
  ...
  def create
    ...
    render json: @company.as_json(only: ["id", "name", "phone_number", "rallying_cry", "fiscal_year_start", "timezone", "preferences", "forum_type", "organisational_forum_type", "display_format"],
                             methods: ["accountability_chart_content", "strategic_plan_content",  "sso_emails", "logo_url", "current_fiscal_quarter", "quarter_for_creating_quarterly_goals", "current_fiscal_year", "year_for_creating_annual_initiatives", "fiscal_year_range", "current_quarter_start_date", "next_quarter_start_date", "forum_meetings_year_range", "forum_intro_video"],
                             include: {
  ...
  def get_onboarding_company
    ...
    render json: @onboarding_company.as_json(only: ["id", "name", "phone_number", "rallying_cry", "fiscal_year_start", "timezone", "preferences", "display_format", "forum_type", "organisational_forum_type", "objectives_key_type"],
                                        methods: ["accountability_chart_content", "strategic_plan_content", "sso_emails", "current_fiscal_quarter", "logo_url", "quarter_for_creating_quarterly_goals", "current_fiscal_year", "year_for_creating_annual_initiatives", "fiscal_year_range", "current_quarter_start_date", "next_quarter_start_date", "forum_meetings_year_range", "forum_intro_video", "forum_types"],
                                        include: {
                                          core_four: { methods: ["core_1_content", "core_2_content", "core_3_content", "core_4_content"] },
                                          sign_up_purpose: { only: ["purpose"] },
                                        })
