class Api::CompaniesController < Api::ApplicationController
  ...
  def show
    ...
    methods: ['accountability_chart_content', 'strategic_plan_content', 'logo_url', 'current_fiscal_quarter', 'quarter_for_creating_quarterly_goals', 'current_fiscal_year', 'year_for_creating_annual_initiatives', 'fiscal_year_range', 'current_quarter_start_date', 'next_quarter_start_date'], 
    include: {
