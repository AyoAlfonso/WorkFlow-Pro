class Api::MeetingsController < Api::ApplicationController
  ...
  def calculate_stats_for_week
    ...
    ka_created_change = ka_created_2_weeks != 0 ? ka_created_last_week / ka_created_2_weeks : 0
    ...
    ka_completed_change = ka_completed_2_weeks != 0 ? ka_completed_last_week / ka_completed_2_weeks : 0
    ...
    issues_created_change = issues_created_2_weeks != 0 ? issues_created_last_week / issues_created_2_weeks : 0
